...
public class C03_DependsOn {
    ...
    @Test
    public void test1(){//***beklenen url yamlış yazılırsa sonuna 1 eklenirse mesela test hata vererek durur ve diğer testlere geçmez***
    ...
    public void test3(){
        ...
        Assert.assertEquals(fiyat.getText(),"$16.83","fiyat eşit değil");
    }
    @AfterClass
